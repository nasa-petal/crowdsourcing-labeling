...
labeling_job_name = 'ground-truth-petal-quadrant-test-7'
task_title = 'Multi-label text classification task of journal papers related to biomimicry: herb only test: test 7'
