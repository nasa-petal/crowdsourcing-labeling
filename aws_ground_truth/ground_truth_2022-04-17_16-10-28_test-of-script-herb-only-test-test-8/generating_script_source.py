...
labeling_job_name = 'ground-truth-petal-quadrant-test-8'
task_title = 'Multi-label text classification task of journal papers related to biomimicry: herb only test: test 8'
comment = 'test of script herb only test-test 8'
