...
labeling_job_name = 'ground-truth-petal-quadrant-test-6'
task_title = 'Multi-label text classification task of journal papers related to biomimicry: herb only test: test 6'
